...
public class Problema_5_2 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnListar(ActionEvent arg0) {
		...
		for (int i=0; i<as.tamanio(); i++){
			imprimir("n[" + i + "]: " + String.format("%.1f",as.obtener(i) ));
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("Promedio sueldos : "+ String.format("%.1f", as.retonarPromedioSueldos()));
		imprimir("Sueldo Mayor : "+ String.format("%.1f", as.sueldoMayor()));
		imprimir("Sueldo Menor: "+ String.format("%.1f", as.sueldoMenor()));
		imprimir("Cantidad mayores sueldos: "+ as.cantidadMayoresSueldoPromedio());
		imprimir("Cantidad menores sueldos: "+ as.cantidadMenoresSueldoPromedio());
		imprimir("Posicion del Segundo sueldo mayor minimo: "+ as.posSegundoSueldoMayorAlMinimo());
		imprimir("Posicion del Ultimo sueldo menor minimo: "+ as.posUltimoSueldoMenorAlMinimo());
