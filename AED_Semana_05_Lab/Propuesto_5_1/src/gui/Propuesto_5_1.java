...
public class Propuesto_5_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir();
		imprimir("Promedio edades                            :  " + an.retonarPromedioNotas());
		...
		imprimir("Posicion de la Primera nota Aprobatoria    :  " + an.posPrimeraNotaAprobatoria());
		imprimir("Posicon de la Penultima nota desaprobatoria:  " + an.posPenultimaNotaDesaprobatoria());
